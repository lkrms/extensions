...
order by short_name, course_id"
    ...
    "sections" => array(
        ...
        "sql" => array(
            "select distinct attendprd.att_year + " . (CANVAS_ALL_YEAR_COURSES ? "'" . CANVAS_ALL_YEAR_COURSE_ID_SUFFIX . "'" : "'T' + rtrim(attendprd.att_period)") . " + 'C' + rtrim(tchsub.sub_code) + 'L' + tchsub.class as section_id,
    attendprd.att_year + " . (CANVAS_ALL_YEAR_COURSES ? "'" . CANVAS_ALL_YEAR_COURSE_ID_SUFFIX . "'" : "'T' + rtrim(attendprd.att_period)") . " + 'C' + tchsub.sub_code as course_id,
...
order by name, section_id"
    ...
    'student' as role,
    attendprd.att_year + " . (CANVAS_ALL_YEAR_COURSES ? "'" . CANVAS_ALL_YEAR_COURSE_ID_SUFFIX . "'" : "'T' + rtrim(attendprd.att_period)") . " + 'C' + rtrim(tchsub.sub_code) + 'L' + tchsub.class as section_id,
    'active' as status,
